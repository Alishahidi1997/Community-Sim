...
def build_default_config() -> SimulationConfig:
    return SimulationConfig(
        ...
        demographics=DemographicsConfig(
            ...
            reproductive_age_max=44,
            base_birth_rate=0.32,
            partner_match_rate=0.8,
            child_mortality=0.008,
            natural_mortality_base=0.003,
            natural_mortality_age_factor=0.00035,
            fertility_trait_weight=0.45,
        ),
        environment=EnvironmentConfig(
            base_food_per_capita=1.0,
            food_variability=0.15,
            environmental_stress=0.03,
